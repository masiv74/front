...
import { Button, TextField, FormControl, InputLabel, MenuItem, Select as MuiSelect } from "@mui/material";
    ...
    try {
      ...
      if (response.data.distri) {
        return response.data.distri.map((distrito) => ({
          ...
          distrito: distrito.distrito,  // Incluimos el nombre del distrito
        }));
      } else {
        return [];
      }
  ...
  const handleCreateUser = async () => {
    try {
      ...
      const usuarioData = {
        ...
        distrito: selectedDistrito ? selectedDistrito.distrito.toUpperCase() : null, // Añadimos el nombre del distrito
  ...
  return (
    <div className="max-w-md mx-auto p-4 bg-white rounded-lg shadow-lg">
      ...
      <FormControl variant="outlined" size="small" fullWidth margin="normal">
        <InputLabel id="tpuser-select-label" color="success" className="text-green-600">
          Tipo de Usuario
        </InputLabel>
        <MuiSelect
