...
import { CambiarPassModal } from "../adminmant/CambiarPassModal";

export const ViewUsuariosim = () => {
        ...
        <div className="py-8">
          ...
          <div className="flex flex-row items-center space-x-2 mb-4">
            <FormControl variant="outlined" size="small">
              <InputLabel id="tpuser-select-label">
              ...
              >
                {tpUserOptions
                  ...
                  .map((option) => (
                    <MenuItem
                      key={option.idTipoUsuario}
                      value={option.idTipoUsuario}
                    >
                    ...
                    <TableRow key={index}>
                      ...
                      <TableCell align="center">
                        <Switch
                          checked={user.activo}
                          onChange={(e) =>
                            handleSwitchChange(user.id, e.target.checked)
                          }
                          color="primary"
                        />
                      </TableCell>
